      ...
      setState(() {
        ...
        acting = combinedCredits
            .map((e) => {
                  ...
                  'character':
                      e['character'] == null ? 'unknow' : e['character']
                })
            .toList();
                                                              ...
                                                              builder: (context) =>
                                                                  new Description(
                                                                    ...
                                                                    name: acting[
                                                                        ...
                                                                        [
                                                                        'title'],
                                                                    bannerurl: acting[index]['backdrop_path'] ==
                                                                            null
                                                                        ? 'empty'
                                                                        : 'https://image.tmdb.org/t/p/w500' +
                                                                            acting[index]['backdrop_path'],
                                                                    posterurl: acting[index]['poster_path'] ==
                                                                            null
                                                                        ? 'empty'
                                                                        : 'https://image.tmdb.org/t/p/w500' +
                                                                            acting[index]['poster_path'],
                                                                    description:
                                                                        acting[index]
                                                                            [
                                                                            'overview'],
